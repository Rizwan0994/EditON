...
const VerificationSuccessPage = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${import.meta.env.VITE_NODE_API}verify/${token}`)
      .then((response) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>
      ...
      {error ? (
        ...
        <NavLink to="/completeRegistration" style={{ textDecoration: 'none', color: 'blue' }}>
          <button style={{ padding: '10px 20px', fontSize: '18px', backgroundColor: 'blue', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
